...
class ArticuloRoutes {
    ...
    config() {
        ...
        this.router.get('/listArticulosByInstitutoByPeriodo/:idInstituto/:ini/:fin', articuloController_1.articuloController.listArticulosByInstitutoByPeriodo);
        this.router.get('/listArticulosAllByInstitutoByPeriodo/:ini/:fin', articuloController_1.articuloController.listArticulosAllByInstitutoByPeriodo);
    }
}
