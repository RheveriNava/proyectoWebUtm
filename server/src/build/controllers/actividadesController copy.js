...
class ActividadesController {
    ...
    ActividadessByInsituto(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log("ActividadessByCarrera");
            const { idInstituto } = req.params;
            const resp = yield database_1.default.query("SELECT DISTINCT Actividades.* FROM Actividades,profesores WHERE Actividades.idProfesor = profesores.idProfesor AND profesores.idInstituto = ?", [idInstituto]);
            res.json(resp);
        });
    }
